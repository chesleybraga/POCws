...
var WebSocketAPI = /** @class */ (function () {
    function WebSocketAPI(appComponent) {
    ...
    WebSocketAPI.prototype._connect = function () {
        ...
        var websocket = new WebSocket(this.webSocketEndPoint);
    ...
    ;
    WebSocketAPI.prototype.subscribe = function () {
        debugger;
     ...
     * @param {*} message
     */
    WebSocketAPI.prototype._send = function (message) {
        console.log("sending message via web socket: " + message);
        debugger;
        this.stompClient.send("/app/hello", {}, JSON.stringify(message));
    };
    WebSocketAPI.prototype.getUrl = function () {
        var url = (window.location.host).split(':');
        return url[0];
    };
    WebSocketAPI.prototype.onMessageReceived = function (message) {
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.handleMessage = function (message) {
